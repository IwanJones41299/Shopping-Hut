  ...
  const onSubmit = (e) => {
    ...
    AuthService.login(user).then((data) => {
      ...
      if (isAuthenticated) {
        ...
        setMessage(message); //Error message on log in doesnt work, needs fixing
      }
    });
  };
          ...
          <Container fluid className="browser_loginForm">
            <Row>
              ...
              <Col className="col-3 browser_title">
                ...
                <Card.Text className="b_loginText" style={{ fontSize: "1.3em" }}>
                  Welcome Back! <br />
                  Sign in and carry on creating your <br /> shopping list
                </Card.Text>
                <Link to="/register"><Card.Text className="reg-link">Create an account...</Card.Text></Link>
              </Col>
              <Col className="col-3 browser_login">
                <Form onSubmit={onSubmit}>
                  ...
                  <Button variant="primary" type="submit" className="login-btnBrowser btn-block">
                    Login
                  </Button>
                  <Link to="/reset"><Card.Text className="reg-link mt-4">Reset Password...</Card.Text></Link>
                  {message ? <Message message={message} /> : null}
                </Form>
              </Col>
              <Col className="Col-3" />
